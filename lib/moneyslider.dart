...
class _MoneySliderState extends State<MoneySlider> {
  ...
  Future<Object> createPost(String url, sliderValue) async {
  return http.post(url, body: sliderValue.then((http.Response response) {
                          ...
                          child: Container(child: Slider(
                            ...
                            onChanged: (newValue) {
                              setState(() {
                                ...
                                createPost('http://localhost:3000', sliderValue);
                              });
                            },
                          ),),
                        ),
