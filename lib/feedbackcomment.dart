...
class _HomePageState extends State<HomePage> {
  ...
  Future<Object> createPost() async {
    var url = "http://192.168.10.35:3000/flutter/slider";
  return http.post(url, body: sliderValue.toString()).then((http.Response response) {
